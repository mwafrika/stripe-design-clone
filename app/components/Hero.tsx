        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center py-16 lg:py-24">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm px-3 py-1 text-sm text-white mb-8">
              ...
              <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl leading-tight mb-8">
                Customer insights{" "}
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto lg:mx-0">
                <input
                  ...
                  className="flex-1 rounded-full border-0 bg-white/10 backdrop-blur-sm px-5 py-4 text-white placeholder:text-white/60 focus:ring-2 focus:ring-white/50 focus:outline-none text-base"
                />
                <button className="rounded-full bg-gray-900 px-8 py-4 text-base font-semibold text-white hover:bg-gray-800 transition-colors whitespace-nowrap">
                  Start now
                  <svg
